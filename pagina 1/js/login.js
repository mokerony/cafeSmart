document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchUsers() {
        try {
            const response = await fetch('https://mokerony.github.io/taller/login.json'); // Asegúrate de que la ruta a login.json sea correcta
            const users = await response.json();
            console.log('Usuarios cargados:', users);  // Mostrar los usuarios cargados en la consola
            return users;
        } catch (error) {
